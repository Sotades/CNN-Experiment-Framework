...
def build_model_128x128(experiment_name, epochs, batch_size, lamda, learning_rate, optimizer_type, path_to_128):
    img_width = 128
    img_height = 128
    input_shape = (img_width, img_height, 3)

    train_data_dir = path_to_128 + '/train'
    validation_data_dir = path_to_128 + '/validate'
